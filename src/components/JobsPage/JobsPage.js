  ...
  return (
    <div className="jobs-parent">
      <div className="jobs-header">
        <Nav handleLogout={handleLogout} user={userToken} />
        <div style={{ marginLeft: "5%", marginTop: "12px" }}>
      ...
      <div className="jobs-main">
          ...
          <div className="cards">
            {currentPosts.map((post) => (
              <>
                <Card
                  post={post}
                  onClick={() => getOneJobCandidates(post.id)}
        ...
        <Modal onClose={() => closeModal(show)} show={show}>
          <div className="modal-parent">
            <div className="modal-child">
              <div className="close-header">
                <div className="modal-header">Modal Header</div>
                <button onClick={() => closeModal(show)} className="button">
                  Close
                </button>
              </div>
              <div>
              ...
              <div className="modal-span">
                {candidates["data"] && (
                  <span>{candidates.data.length} Total applicants</span>
                )}
                {!candidates["data"] && <span>0 Applicants</span>}
              </div>
              {candidates["data"] && (
